...
## Environments
- Preview: https://main--rnitu-edge-site--rnituadobe.aem.page/
- Live: https://main--rnitu-edge-site--rnituadobe.aem.live/
...
1. Open the `rnitu-edge-site` directory in your favorite IDE and start coding :)
